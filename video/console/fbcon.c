...
//static int vbl_cursor_cnt;/*2020.09.08 - zoffy.yu - Removed black block in lcd  3-1*/
...
{
#if 0   /*2020.09.08 - zoffy.yu - Removed black block in lcd  3-2*/
...
static void fbcon_cursor(struct vc_data *vc, int mode)
{
#if 0    /*2020.09.08 - zoffy.yu - Removed black block in lcd  3-3*/
	struct fb_info *info = registered_fb[con2fb_map[vc->vc_num]];
	struct fbcon_ops *ops = info->fbcon_par;
	int y;
